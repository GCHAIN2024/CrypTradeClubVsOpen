...
BEGIN
    ...
    CREATE TABLE Social_Bookmark ([ID] BIGINT NOT NULL
        ...
        ,[Notes] NVARCHAR(MAX)
        ,[Path] NVARCHAR(MAX)
        ,[UserGroup] NVARCHAR(64) COLLATE Chinese_PRC_CI_AS
        ,[Type] BIGINT
...
DECLARE cursor_Social_Bookmark CURSOR FOR 
    SELECT name FROM SYSCOLUMNS WHERE id=object_id('Social_Bookmark') AND (name NOT IN ('ID','Createdat','Updatedat','Sort','Agent','EndUser','Bind','BindType','BookmarkList','Notes','Path','UserGroup','Type'))
...
IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_BookmarkAgent')
    BEGIN
    ALTER TABLE Social_Bookmark DROP  CONSTRAINT [Constraint_Social_BookmarkAgent]
    END
...
IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_BookmarkEndUser')
    BEGIN
    ALTER TABLE Social_Bookmark DROP  CONSTRAINT [Constraint_Social_BookmarkEndUser]
    END
...
IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_BookmarkBind')
    BEGIN
    ALTER TABLE Social_Bookmark DROP  CONSTRAINT [Constraint_Social_BookmarkBind]
    END
...
IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_BookmarkBindType')
    BEGIN
    ALTER TABLE Social_Bookmark DROP  CONSTRAINT [Constraint_Social_BookmarkBindType]
    END
...
IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_BookmarkBookmarkList')
    BEGIN
    ALTER TABLE Social_Bookmark DROP  CONSTRAINT [Constraint_Social_BookmarkBookmarkList]
    END
...
IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_BookmarkNotes')
    BEGIN
    ALTER TABLE Social_Bookmark DROP  CONSTRAINT [Constraint_Social_BookmarkNotes]
    END
...
IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_BookmarkPath')
    BEGIN
    ALTER TABLE Social_Bookmark DROP  CONSTRAINT [Constraint_Social_BookmarkPath]
    END
...
IF EXISTS(SELECT * FROM SYSCOLUMNS WHERE id=object_id('Social_Bookmark') AND name='UserGroup')
    BEGIN
     ALTER TABLE Social_Bookmark ALTER COLUMN [UserGroup] NVARCHAR(64) COLLATE Chinese_PRC_CI_AS
    END
ELSE
    BEGIN
    DECLARE @sql_add_Social_Bookmark_UserGroup NVARCHAR(MAX);
    SET @sql_add_Social_Bookmark_UserGroup = 'ALTER TABLE Social_Bookmark ADD [UserGroup] NVARCHAR(64) COLLATE Chinese_PRC_CI_AS'
    EXEC sp_executesql @sql_add_Social_Bookmark_UserGroup
    END


IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_BookmarkUserGroup')
    BEGIN
    ALTER TABLE Social_Bookmark DROP  CONSTRAINT [Constraint_Social_BookmarkUserGroup]
    END

IF EXISTS(SELECT * FROM SYSINDEXES WHERE name='UniqueNonclustered_Social_BookmarkUserGroup')
    BEGIN
    ALTER TABLE Social_Bookmark DROP  CONSTRAINT [UniqueNonclustered_Social_BookmarkUserGroup]
    END
...
IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_BookmarkType')
    BEGIN
    ALTER TABLE Social_Bookmark DROP  CONSTRAINT [Constraint_Social_BookmarkType]
    END
...
DECLARE cursor_Social_BookmarkList CURSOR FOR 
    SELECT name FROM SYSCOLUMNS WHERE id=object_id('Social_BookmarkList') AND (name NOT IN ('ID','Createdat','Updatedat','Sort','EndUser','Caption','Icon','Background','DescTxt','Privacy','Moment','Type'))
...
IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_BookmarkListEndUser')
    BEGIN
    ALTER TABLE Social_BookmarkList DROP  CONSTRAINT [Constraint_Social_BookmarkListEndUser]
    END
...
IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_BookmarkListCaption')
    BEGIN
    ALTER TABLE Social_BookmarkList DROP  CONSTRAINT [Constraint_Social_BookmarkListCaption]
    END
...
IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_BookmarkListIcon')
    BEGIN
    ALTER TABLE Social_BookmarkList DROP  CONSTRAINT [Constraint_Social_BookmarkListIcon]
    END
...
IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_BookmarkListBackground')
    BEGIN
    ALTER TABLE Social_BookmarkList DROP  CONSTRAINT [Constraint_Social_BookmarkListBackground]
    END
...
IF EXISTS(SELECT * FROM SYSCOLUMNS WHERE id=object_id('Social_BookmarkList') AND name='DescTxt')
    BEGIN
     ALTER TABLE Social_BookmarkList ALTER COLUMN [DescTxt] NVARCHAR(MAX)
    END
ELSE
    BEGIN
    DECLARE @sql_add_Social_BookmarkList_DescTxt NVARCHAR(MAX);
    SET @sql_add_Social_BookmarkList_DescTxt = 'ALTER TABLE Social_BookmarkList ADD [DescTxt] NVARCHAR(MAX)'
    EXEC sp_executesql @sql_add_Social_BookmarkList_DescTxt
    END


IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_BookmarkListDescTxt')
    BEGIN
    ALTER TABLE Social_BookmarkList DROP  CONSTRAINT [Constraint_Social_BookmarkListDescTxt]
    END

IF EXISTS(SELECT * FROM SYSINDEXES WHERE name='UniqueNonclustered_Social_BookmarkListDescTxt')
    BEGIN
    ALTER TABLE Social_BookmarkList DROP  CONSTRAINT [UniqueNonclustered_Social_BookmarkListDescTxt]
    END
...
IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_BookmarkListPrivacy')
    BEGIN
    ALTER TABLE Social_BookmarkList DROP  CONSTRAINT [Constraint_Social_BookmarkListPrivacy]
    END
...
IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_BookmarkListMoment')
    BEGIN
    ALTER TABLE Social_BookmarkList DROP  CONSTRAINT [Constraint_Social_BookmarkListMoment]
    END
...
IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_BookmarkListType')
    BEGIN
    ALTER TABLE Social_BookmarkList DROP  CONSTRAINT [Constraint_Social_BookmarkListType]
    END
...
IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_FollowEndUser')
    BEGIN
    ALTER TABLE Social_Follow DROP  CONSTRAINT [Constraint_Social_FollowEndUser]
    END
...
IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_FollowFollowee')
    BEGIN
    ALTER TABLE Social_Follow DROP  CONSTRAINT [Constraint_Social_FollowFollowee]
    END
...
IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_FollowFollowType')
    BEGIN
    ALTER TABLE Social_Follow DROP  CONSTRAINT [Constraint_Social_FollowFollowType]
    END
...
DECLARE cursor_Social_Moment CURSOR FOR 
    SELECT name FROM SYSCOLUMNS WHERE id=object_id('Social_Moment') AND (name NOT IN ('ID','Createdat','Updatedat','Sort','Agent','Bind','BindType','BizCode','Lang','Title','Summary','FullText','PreviewImgUrl','Link','Type','Question','State','UserGroup','Postedat','Keywords','MediaType','UrlOriginal','OID','PostType','AudioUrl'))
...
IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_MomentAgent')
    BEGIN
    ALTER TABLE Social_Moment DROP  CONSTRAINT [Constraint_Social_MomentAgent]
    END
...
IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_MomentBind')
    BEGIN
    ALTER TABLE Social_Moment DROP  CONSTRAINT [Constraint_Social_MomentBind]
    END
...
IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_MomentBindType')
    BEGIN
    ALTER TABLE Social_Moment DROP  CONSTRAINT [Constraint_Social_MomentBindType]
    END
...
IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_MomentBizCode')
    BEGIN
    ALTER TABLE Social_Moment DROP  CONSTRAINT [Constraint_Social_MomentBizCode]
    END
...
IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_MomentLang')
    BEGIN
    ALTER TABLE Social_Moment DROP  CONSTRAINT [Constraint_Social_MomentLang]
    END
...
IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_MomentQuestion')
    BEGIN
    ALTER TABLE Social_Moment DROP  CONSTRAINT [Constraint_Social_MomentQuestion]
    END
...
IF EXISTS(SELECT * FROM SYSCOLUMNS WHERE id=object_id('Social_Moment') AND name='UserGroup')
    BEGIN
     ALTER TABLE Social_Moment ALTER COLUMN [UserGroup] BIGINT
    END
ELSE
    BEGIN
    DECLARE @sql_add_Social_Moment_UserGroup NVARCHAR(MAX);
    SET @sql_add_Social_Moment_UserGroup = 'ALTER TABLE Social_Moment ADD [UserGroup] BIGINT'
    EXEC sp_executesql @sql_add_Social_Moment_UserGroup
    END


IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_MomentUserGroup')
    BEGIN
    ALTER TABLE Social_Moment DROP  CONSTRAINT [Constraint_Social_MomentUserGroup]
    END

IF EXISTS(SELECT * FROM SYSINDEXES WHERE name='UniqueNonclustered_Social_MomentUserGroup')
    BEGIN
    ALTER TABLE Social_Moment DROP  CONSTRAINT [UniqueNonclustered_Social_MomentUserGroup]
    END
...
IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_MomentPostedat')
    BEGIN
    ALTER TABLE Social_Moment DROP  CONSTRAINT [Constraint_Social_MomentPostedat]
    END
...
IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_MomentKeywords')
    BEGIN
    ALTER TABLE Social_Moment DROP  CONSTRAINT [Constraint_Social_MomentKeywords]
    END
...
IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_MomentUrlOriginal')
    BEGIN
    ALTER TABLE Social_Moment DROP  CONSTRAINT [Constraint_Social_MomentUrlOriginal]
    END
...
IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_MomentOID')
    BEGIN
    ALTER TABLE Social_Moment DROP  CONSTRAINT [Constraint_Social_MomentOID]
    END
...
IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_MomentPostType')
    BEGIN
    ALTER TABLE Social_Moment DROP  CONSTRAINT [Constraint_Social_MomentPostType]
    END
...
IF EXISTS(SELECT object_id FROM [sys].[objects] WHERE name='Constraint_Social_MomentAudioUrl')
    BEGIN
    ALTER TABLE Social_Moment DROP  CONSTRAINT [Constraint_Social_MomentAudioUrl]
    END
